...
public class QueryManagement {
  ...
  public static final String INSERT_INTO_SERIAL_CALIBRATION_QUEUED = "INSERT INTO `serial_calibration_queued`"
          + "(`uploaded`, `shift_start`, `shift_finish`, `unit_id`, `sale_number`, `meter_number`, "
          + "`cal_num`, `shift_net`, `shift_gross`, `end_net_total`, `end_totalizer`, `deliveries`)"
          + "VALUES (0,?,?,?,?,?,?,?,?,?,?,?)";
  ...
  public static final String SELECT_QUEUED_CALIBRATION = "SELECT `id`, `uploaded`, `shift_start`, "
          + "`shift_finish`, `unit_id`,`sale_number`, `meter_number`, `cal_num`, `shift_net`, `shift_gross`, `end_net_total`, "
